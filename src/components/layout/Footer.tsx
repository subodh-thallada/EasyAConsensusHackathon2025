...
const Footer = () => {
  return (
    <footer className="bg-[#0D1117] border-t border-[#2D333B] py-10 mt-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/dashboard" className="text-sm text-muted-foreground hover:text-white">
                  Dashboard
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-sm text-muted-foreground hover:text-white">
                  About
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 border-t border-[#2D333B] pt-8 md:flex md:items-center md:justify-between">
